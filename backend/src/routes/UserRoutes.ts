...
import { checkJWTtokenBalance } from "../middlewares/TokenMiddleware.js";
 ...
 * 
 */
userRouter.post("/imbarcazione/send/status", checkJWTtokenBalance, checkDatiInviati, async function(req: Request, res: Response) {
 ...
 */
userRouter.get("/imbarcazioni/get/my/status/geoareaid/:geoarea_id", checkJWTtokenBalance, checkUserRole, async function(req: Request, res: Response) {
